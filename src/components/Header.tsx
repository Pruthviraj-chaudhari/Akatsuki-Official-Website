...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ease-in-out ${scrolled ? 'bg-black/70' : 'bg-transparent'} h-[80px]`}
    >
          ...
          <ul className="flex space-x-8">
            ...
            <li className="relative">
              ...
              <ul className="absolute left-0 mt-2 w-48 bg-white shadow-lg opacity-0 invisible transition-opacity duration-300 ease-in-out group-hover:opacity-100 group-hover:visible">
                ...
                <li>
                  <a className="block px-4 py-2 text-gray-800 hover:bg-red-100" href="#">
                    Deep Drop Down 1
                  </a>
                </li>
              </ul>
